...
| Change chat behaviour | `services/chat-api/AGENTS.md` | [`architecture.md`](architecture.md), contract tests and the affected Python module |
...
Specialised permanent references remain in [`AUDIO_LICENSE.md`](AUDIO_LICENSE.md), [`CONTENT_AND_CLAIMS.md`](CONTENT_AND_CLAIMS.md), [`THIRD_PARTY.md`](THIRD_PARTY.md) and [`UI_SYSTEM.md`](UI_SYSTEM.md).
